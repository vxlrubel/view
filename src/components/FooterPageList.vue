<template>
  <ul class="list-unstyled p-0 m-0">
    ...
    <li><RouterLink to="/about" class="text-decoration-none text-dark text-capitalize">about</RouterLink></li>
    <li><RouterLink to="/blog" class="text-decoration-none text-dark text-capitalize">blog</RouterLink></li>
    <li><RouterLink to="/contact" class="text-decoration-none text-dark text-capitalize">contact</RouterLink></li>
  </ul>
</template>
